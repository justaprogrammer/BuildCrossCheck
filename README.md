...
MSBuildLogOctokitChecker is a MSBuild Binary log reading GitHub App. Integrate it with the build process of any repository that uses MSBuild, and it'll identify build warnings and errors in Pull Requests that you open.
